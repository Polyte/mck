...
const TestimonialsCarousel = memo(() => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      testimonial:
        "The provincial road rehabilitation exceeded all expectations. McKeywa's team demonstrated exceptional professionalism and advanced construction techniques.",
